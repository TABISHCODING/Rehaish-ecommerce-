...
namespace MyntraClone.API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        // ✅ Public: Get full category hierarchy
        [HttpGet("hierarchy")]
        ...
        // ✅ Public: Get root categories only
        [HttpGet("roots")]
        public async Task<IActionResult> GetRoots()
        {
            var roots = await _service.GetRootCategoriesAsync();
            return Ok(roots);
        }

        // ✅ Public: Get subcategories of a parent category
        [HttpGet("{parentId}/subcategories")]
        public async Task<IActionResult> GetSubCategories(int parentId)
        {
            var subcategories = await _service.GetSubCategoriesAsync(parentId);
